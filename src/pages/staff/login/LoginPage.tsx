...
export default function StaffLoginPage() {
  ...
  return (
    <div className="py-12 px-4 sm:px-2 lg:px-8">
      <div className="bg-amber-50 p-4 rounded-lg border border-amber-600">
        ...
        <div className="text-center md:text-lg text-base font-semibold">
          <p className="mt-4">
          ...
          <p className="md:text-base text-sm mt-5 text-gray-600">
            모든 데이터는 기밀이며, 외부로의 유출·공유를 금지합니다. <br />
            업무 외 무단 열람·복제 및 개인적 사용을 금지합니다. <br /> 이를
            위반할 경우 관련 법규에 따른 책임을 질 수 있습니다.
          </p>
        </div>
      </div>
      ...
      <form
        ...
        className="mt-10 flex flex-col gap-4 w-full md:w-3/4  mx-auto"
      >
        {error && (
