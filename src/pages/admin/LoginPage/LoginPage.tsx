    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-white p-6 gap-21.5">
      <div className="w-176 px-4.75 py-6 bg-black/2 border border-primary-600 rounded-2xl relative">
        <div className="flex items-center justify-center gap-[4.89px] mb-4">
          ...
          >
            <path
              d="M22 4L4 12V20C4 31.1 11.88 41.38 22 44C32.12 41.38 40 31.1 40 20V12L22 4Z"
              stroke="#FCD34D"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M22 4L4 12V20C4 31.1 11.88 41.38 22 44"
              stroke="#FCD34D"
              strokeWidth="2"
              fill="none"
            />
          ...
          >
            <path
              d="M22 6L6 22L22 38L38 22L22 6Z"
              stroke="#FCD34D"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M22 12L12 22L22 32L32 22L22 12Z"
              stroke="#FCD34D"
              strokeWidth="2"
              fill="none"
            />
        ...
        <div className="text-center [&_p]:text-17 [&_p]:font-medium [&_p]:text-bg-800 [&_p]:leading-[1.4] [&_p]:mb-0">
          ...
          <p>
            어떠한 경우에도 외부(타 지점, 협력업체, 지인, 온라인 등)로
            유출하거나 공유할 수 없습니다.
          </p>
          <p>
      ...
      <form className="w-118 flex flex-col gap-21.5" onSubmit={handleLogin}>
        <div className="flex flex-col gap-6 [&_.input-wrapper]:w-full [&_.input]:w-full">
          ...
          />
          {error && (
            <p className="text-15 text-red-700 text-center m-0">{error}</p>
          )}
        </div>
