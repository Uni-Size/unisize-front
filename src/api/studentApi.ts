    ...
    recommended_uniforms: {
      winter:
        orderDetail.uniform_items.winter?.map((item) => ({
          ...
          selectable_with: [],
          gender: orderDetail.student.gender === "M" ? ("male" as const) : ("female" as const),
